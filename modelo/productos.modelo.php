...
class ProductosModelo {
            ...
            if (!empty($categoria)) {
                ...
                $stmt->bindParam(":fecha_actualizacion_categoria", $fecha_actualizacion, PDO::PARAM_STR);
                    ...
                    if ($stmt->execute()) {
                        ...
                        // Manejo de error si ocurre algún problema al ejecutar la consulta
                        // Puedes agregar aquí el código correspondiente
                    }
            }
        }
    ...
    static public function mdlActualizarInformacion($table, $data, $id, $nameId){
        ...
        $set = substr($set, 0, -1); //Quita ultima coma
    ...
    static public function mdlGetDatosProducto($codigoProducto){
        $stmt = Conexion::conectar()->prepare("SELECT   id,
                                                        ...
                                                        '1' as cantidad,
                                                         ...
                                                         '' as acciones,
                                                         c.aplica_peso
                                                         from productos p inner join categorias c on p.id_categoria_producto = c.id_categoria where codigo_producto = :codigoProducto and p.stock_producto > 0");
