    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Productos / Inventario</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="card card-info">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <button type="button" class="btn btn-tool text" id="btnLimpiarBusqueda">
    ...
    <div class="modal fade" id="mdlGestionarProducto" role="dialog">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <!-- Cabecera del modal -->
                <div class="modal-header bg-green py-1 align-items-center">
                ...
                <div class="modal-body">
                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <!-- Columna para descripción de la categoria del producto -->
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    <label class="" for="iptDescripcionReg"><i
                                        class="fas fa-file-signature fs-6"></i> <span
                                        class="small">Descripción</span><span class="text-danger">*</span>
                                    </label>
                            ...
                            <!--Creación de botones para cancelar y guardar el producto -->
...
<!---------------------------------------------------------------------------------------------------->
    ...
    <!-- Ventana Modal para registro de stock -->
    <div class="modal fade" id="mdlGestionarStock" tabinex="-1" aria-labelledy="exampleModalLabel" aria_hidden="true">
...
<script>
    ...
    var accion;
    var table;
    var operacion_stock = 0; //permitir definir si vamos a sumar o restar al stock (1: sumar / 2:restar)
...
$(document).ready(function(){
    ...
    /*========================================================================================*/
    /*   CARGA DEL LISTADO CON EL PLUGIN DATATABLE JS (VER TABLAS EN PANTALLA DE INVENTARIO)  */
    /*========================================================================================*/
    ...
    /*=======================================================================*/
    /*   EVENTO PARA CRITERIOS DE BUSQUEDA (CODIGO, CATEGORIA Y PRODUCTO)   */
    /*=====================================================================*/
    ...
    $('#tbl_productos tbody').on('click', '.btnAumentarStock', function(){
        ...
        $("#titulo_modal_label").html('Agregar al Stock'); //CAMBIAR EL TEXTO DEL LABEL DEL IMPUT PARA INGRESO DE STOCK
        ...
        $("#stock_codigoProducto").html(data[2])    // CODIDO DEL PRODUCTO DEL DATATABLE
    ...
    /*=========================================================================*/
    // EVENTO QUE AL DAR CLICK EN EL BOTON DISMINUIR STOCK
    /*=========================================================================*/
    $('#tbl_productos tbody').on('click', '.btnDisminuirStock', function() {
        ...
        $("#titulo_modal_label").html('Disminuir al Stock');    // Cambiar el texto del label del imput para ingreso de stock
        ...
        $("#stock_Stock").html(data[9])         // Stock actual del producto datatable
    ...
    /*=========================================================================*/
    // EVENTO QUE REGISTRA EN BD EL AUMENTO O DIMINUCION DE STOCK
    /*=========================================================================*/
    $("#btnGuardarNuevoStock").on('click', function() {
    /*mal escrito nuevorStock*/
        if ($("#iptStockSumar").val() != "" && $("#iptStockSumar").val() >0) {
    ...
    $('#tbl_productos tbody').on('click', '.btnEditarProducto', function() {
        ...
        accion =4; //seteamos la accion de editar
    ...
    // EVENTO PARA REMOVER TODA LA CASE //
